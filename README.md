...
```
cd existing_repo
git remote add origin https://gitlab.com/mlops_public/go-is-beautiful.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mlops_public/go-is-beautiful/-/settings/integrations)
